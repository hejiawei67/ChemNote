...
const BLOG = {
  ...
  APPEARANCE_DARK_TIME: process.env.NEXT_PUBLIC_APPEARANCE_DARK_TIME || [18, 6], // 夜间模式起至时间，false时关闭根据POST_URL_PREFIX时间自动切换夜间模式

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'cnvetman', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通的高中化学老师🧑🏻‍🏫', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://chem.cnvetman.icu', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'notion,blog,博客,cnvetman,高中化学', // 网站关键词 英文逗号隔开
  BLOG_FAVICON: process.env.NEXT_PUBLIC_FAVICON || '/favicon.ico', // blog favicon 配置, 默认使用 /public/favicon.ico，支持在线图片，如 https://img.imesong.com/favicon.png
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '辽ICP备2024043810号-1', // 备案号 闽ICP备XXXXXX
